...
- `export_h200_bsr_paper_tables.py` - **fills** the auto-export block in `paper_snippets.md` from `benchmark_training_log.csv` (stdlib only; no pandas). Example: `python scripts/export_h200_bsr_paper_tables.py --csv /path/to/benchmark_training_log.csv --inject paper_snippets.md`
